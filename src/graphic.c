...
/*   Updated: 2023/04/21 16:20:20 by klaksi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	texture_to_img(t_game *game)
{
	game->img[PLAYER] = mlx_texture_to_image(game->mlx,
			&game->xpm[PLAYER]->texture);
	game->img[ITEM] = mlx_texture_to_image(game->mlx,
			&game->xpm[ITEM]->texture);
	game->img[WALL] = mlx_texture_to_image(game->mlx,
			&game->xpm[WALL]->texture);
	game->img[FLOOR] = mlx_texture_to_image(game->mlx,
			&game->xpm[FLOOR]->texture);
	game->img[EXIT_OPEN] = mlx_texture_to_image(game->mlx,
			&game->xpm[EXIT_OPEN]->texture);
	game->img[EXIT_CLOSE] = mlx_texture_to_image(game->mlx,
			&game->xpm[EXIT_CLOSE]->texture);
	if (!game->img[PLAYER]
		|| !game->img[ITEM]
		|| !game->img[WALL]
		|| !game->img[FLOOR]
...
static void	render_element(t_game *game)
{
	if (game->map[game->current.y][game->current.x] == 'P')
	{
		...
		mlx_image_to_window(game->mlx, game->img[ITEM],
...
void	render_window(t_game *game)
{
	...
	mlx_image_to_window(game->mlx, game->img[EXIT_CLOSE],
